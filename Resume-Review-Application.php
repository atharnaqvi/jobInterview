			...
			<select  name="SelectTopic" onchange="pathway(this)" id="selPathway">
			  ...
			  <div id="ITform">
                  ...
                  <div class="uploadFile">
                    <label for="jobSpec">Upload job specifications (optional)</label><br>
                    <input type="file" id="jobSpec" name="jobSpec">
                  </div>
                  <div class="uploadFile">
                    <label for="cv">Upload existing cv (optional)</label><br>
                    <input type="file" id="cv" name="cv">
                  </div>
                  <div class="History">               
                      <label for="educationHistory">Education *</label>
                      <textarea rows="4" cols="50" maxlength="1000" required name="educationHistory" id="educationHistory" class="eduDetail" placeholder="Write your edcuation history in chronical order with highest first"></textarea>                    
                  </div>
                  <div class="History">
                      <label for="jobHistory">Experience *</label><br>
                      <textarea rows="4" cols="50" maxlength="1000" required name="jobHistory" id="jobHistory" class="jobHistory" placeholder="Write your job history in chronical order with latest first"></textarea>
                  </div>
                  <div class="History">
                      <label for="certifications">Certifications</label>
                      <textarea rows="4" cols="50" maxlength="1000" name="certifications" id="certifications" class="certifications" placeholder="State if you have any certification relevant to the job you are aiming for - Latest first"></textarea>
                  </div>
                  <div class="History">
                      <label for="statement">Persoanl statement  (optional)</label>
                      <textarea rows="4" cols="50" maxlength="10000" name="statement" id="statement" class="statement" placeholder="Write your persoanl statement."></textarea>
                  </div>
